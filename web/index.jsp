                    ...
                    <div class="col-md-8 latest-news-body nopadding">
                        <div class="row nopadding">
                            <div class="col-md-6 card-image nopadding">
                                <a href="GetNews?news_id=<%= news_list.get(idx).getNews_id()%>"><img style="height: 300px; object-fit: cover" class="card-img" src="<%= session.getAttribute("location") %><%= news_list.get(idx).getImage() %>" alt="..."></a>
                            </div>
